...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        course1 = Course.objects.create(title='Course 1', description='Описание курса 1', preview='course1_preview.jpg')
        course2 = Course.objects.create(title='Course 2', description='Описание курса 2', preview='course2_preview.jpg')
